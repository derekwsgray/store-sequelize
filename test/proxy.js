...
require('@jagql/framework/lib/handlers/MemoryHandler')
...
var base = path.join(__dirname, '../node_modules/@jagql/framework/test')
...
var articles = require('@jagql/framework')._resources.articles
