...
SqlStore._checkMinServerVersion = function () {
  var serverVersion = require('jagapi')._version
  if (!serverVersion) return
  if (semver.lt(serverVersion, MIN_SERVER_VERSION)) {
    throw new Error('This version of jagapi-sequelize requires jagapi >=' + MIN_SERVER_VERSION + '.')
  }
}
